...
A Digicoin blockchain REST and web socket API service for [Digicoincore Node](https://github.com/digicoinofficial/digicoincore-node)

This is a backend-only service. If you're looking for the web frontend application, take a look at https://github.com/digicoinofficial/digicoin-explorer
...
3. Install digicoincore https://github.com/digicoinofficial/digicoin
...
4. Install digicoincore-node  
    ...
    ```bash
    npm i digicoincore-node

    $(npm bin)/digicoincore-node create mynode

    cd mynode

    $(npm bin)/digicoincore-node install https://github.com/digicoinofficial/digicoin-insight-api.git#master
    ```  
      ...
      "servicesConfig": {
        ...
        "digicoind": {
          "spawn": {
           ...
           "exec": "/home/user/digicoin/src/digicoind"
          }
        }
      }
    }
